...
const LineageData =  {
    ...
    "pathEdgesMap": {
      "WalkIn": [
        ...
        },
        {
          "id": "Doctor-Lab",
          "source": "E1",
          "sourceHandle": "Diagnosis",
          "target": "E2",
          "targetHandle": "BloodTest",
          "animated": true,
          "style": { "stroke": "#28a745", "strokeWidth": 2 }
        },
        {
          "id": "Lab-Pharma",
          "source": "E2",
          "sourceHandle": "BloodTest",
          "target": "E3",
          "targetHandle": "Prescription",
          "animated": true,
          "style": { "stroke": "#28a745", "strokeWidth": 2 }
        },
        {
          "id": "Pharma-Bill",
          "source": "E3",
          "sourceHandle": "Dispense",
          "target": "E4",
          "targetHandle": "GenerateBill",
          "animated": true,
          "style": { "stroke": "#28a745", "strokeWidth": 2 }
        },
        {
          "id": "Bill-Report",
          "source": "E4",
          "sourceHandle": "InsuranceClaim",
          "target": "E5",
          "targetHandle": "SummaryNote",
          "animated": true,
          "style": { "stroke": "#28a745", "strokeWidth": 2 }
        }
      ]
    ...
    "newEdges": [
      ...
      {
        "id": "OnlineBooking-VitalsCheck",
        "source": "E0",

        "sourceHandle": "OnlineBooking",
        "target": "E1",
        "targetHandle": "VitalsCheck",
        "animated": true,
        "style": { "stroke": "#28a745", "strokeWidth": 2 }
      ...
      { 
        "id": "OnlineBooking-Diagnosis",
        "source": "E0",
        "sourceHandle": "OnlineBooking",
        "target": "E1",
        "targetHandle": "Diagnosis",
      ...
      { 
        "id": "VitalsCheck-BloodTest",
        "source": "E1",
        "sourceHandle": "VitalsCheck",
        "target": "E2",
        "targetHandle": "BloodTest",
