...
const LineageData =  {
  "initialNodes": [
    { "id": "header-A", "type": "header", "position": { "x": 100, "y": 20 }, "data": { "label": "Request" } },
    { "id": "E1", "type": "dropdownNode", "position": { "x": 100, "y": 80 }, "data": {
      "title": "Customer Entry", "items": [{ "label": "NewSIM" }, { "label": "PortRequest" }], "expanded": true
    }},
    { "id": "header-B", "type": "header", "position": { "x": 500, "y": 20 }, "data": { "label": "Provisioning" } },
    { "id": "E2", "type": "dropdownNode", "position": { "x": 500, "y": 80 }, "data": {
      "title": "Provision Ops", "items": [{ "label": "NumberActivation" }, { "label": "PlanMapping" }], "expanded": true
    }},
    { "id": "header-C", "type": "header", "position": { "x": 900, "y": 20 }, "data": { "label": "Network" } },
    { "id": "E3", "type": "dropdownNode", "position": { "x": 900, "y": 80 }, "data": {
      "title": "Network Sync", "items": [{ "label": "HSSUpdate" }], "expanded": true
    }}
  ],
  "pathEdgesMap": {
    "NewSIM": [
      { "id": "NewSIM-NumberActivation", "source": "E1", "sourceHandle": "NewSIM", "target": "E2", "targetHandle": "NumberActivation", "animated": true, "style": { "stroke": "#10b981", "strokeWidth": 2 } },
      { "id": "NumberActivation-HSSUpdate", "source": "E2", "sourceHandle": "NumberActivation", "target": "E3", "targetHandle": "HSSUpdate", "animated": true, "style": { "stroke": "#10b981", "strokeWidth": 2 } }
    ]
  },
  "newEdges": [
    { "id": "NewSIM-NumberActivation", "source": "E1", "sourceHandle": "NewSIM", "target": "E2", "targetHandle": "NumberActivation", "animated": true, "style": { "stroke": "#10b981", "strokeWidth": 2 } },
  ...
  "tracePaths": {
    "NewSIM": ["E1", "NewSIM", "E2", "NumberActivation", "E3", "HSSUpdate"]
  }
}
