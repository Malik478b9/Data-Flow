...
const LineageData = {
  "initialNodes": [
    { "id": "header-A", "type": "header", "position": { "x": 100, "y": 20 }, "data": { "label": "User" } },
    { "id": "E1", "type": "dropdownNode", "position": { "x": 100, "y": 80 }, "data": {
      "title": "User Actions", "items": [{ "label": "Browse" }, { "label": "AddToCart" }, { "label": "Checkout" }], "expanded": true
    }},
    { "id": "header-B", "type": "header", "position": { "x": 500, "y": 20 }, "data": { "label": "Order" } },
    { "id": "E2", "type": "dropdownNode", "position": { "x": 500, "y": 80 }, "data": {
      "title": "Order Management", "items": [{ "label": "CreateOrder" }, { "label": "ConfirmOrder" }], "expanded": true
    }},
    { "id": "header-C", "type": "header", "position": { "x": 900, "y": 20 }, "data": { "label": "Payment" } },
    { "id": "E3", "type": "dropdownNode", "position": { "x": 900, "y": 80 }, "data": {
      "title": "Payments", "items": [{ "label": "PaymentGateway" }, { "label": "FraudCheck" }], "expanded": true
    }}
  ],
  "pathEdgesMap": {
    "Checkout": [
      { "id": "Checkout-CreateOrder", "source": "E1", "sourceHandle": "Checkout", "target": "E2", "targetHandle": "CreateOrder", "animated": true, "style": { "stroke": "#3b82f6", "strokeWidth": 2 } },
      { "id": "CreateOrder-ConfirmOrder", "source": "E2", "sourceHandle": "CreateOrder", "target": "E2", "targetHandle": "ConfirmOrder", "animated": true, "style": { "stroke": "#3b82f6", "strokeWidth": 2 } },
      { "id": "ConfirmOrder-PaymentGateway", "source": "E2", "sourceHandle": "ConfirmOrder", "target": "E3", "targetHandle": "PaymentGateway", "animated": true, "style": { "stroke": "#3b82f6", "strokeWidth": 2 } }
    ]
  },
  "newEdges": [
    { "id": "Checkout-CreateOrder", "source": "E1", "sourceHandle": "Checkout", "target": "E2", "targetHandle": "CreateOrder", "animated": true, "style": { "stroke": "#3b82f6", "strokeWidth": 2 } },
  ...
  "tracePaths": {
    "Checkout": ["E1", "Checkout", "E2", "CreateOrder", "E2", "ConfirmOrder", "E3", "PaymentGateway"]
  }
}
