...
const LineageData = {
    "initialNodes": [
      ...
      },
      {
        ...
        "data": {
          "title": "Txn Processing",
          "items": [
            {
              "label": "CoreBanking"
            },
            {
              "label": "TransactionQueue"
            }
          ],
          "expanded": true
        }
    ...
    "pathEdgesMap": {
      "POS": [
        ...
        },
        {
          "id": "Core-Risk",
          "source": "E11",
          "sourceHandle": "CoreBanking",
          "target": "E21",
          "targetHandle": "AMLCheck",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
        ...
        },
        {
          "id": "Risk-GL",
          "source": "E21",
          "sourceHandle": "AMLCheck",
          "target": "E31",
          "targetHandle": "TxnEntry",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
        ...
        },
        {
          "id": "GL-Reg",
          "source": "E31",
          "sourceHandle": "TxnEntry",
          "target": "E41",
          "targetHandle": "BaselTagging",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
        ...
        },
        {
          "id": "Reg-BI",
          "source": "E41",
          "sourceHandle": "BaselTagging",
          "target": "E51",
          "targetHandle": "MISReports",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
        ...
        {
          "id": "BaselTagging-Dashboards",
          "source": "E41",
          "sourceHandle": "BaselTagging",
          "target": "E51",
          "targetHandle": "Dashboards",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
      ...
      "OnlinePortal": [
        {
          "id": "OnlinePortal-TransactionQueue",
          "source": "E0",
          "sourceHandle": "OnlinePortal",
          "target": "E11",
          "targetHandle": "TransactionQueue",
          "animated": true,
          "style": {
            "stroke": "#007bff",
            "strokeWidth": 2
        ...
        {
          "id": "TransactionQueue-TxnEntry",
          "source": "E11",
          "sourceHandle": "TransactionQueue",
          "target": "E31",
          "targetHandle": "TxnEntry",
          "animated": true,
          "style": {
    ...
    "newEdges": [
      ...
      {
        "id": "TransactionQueue-FraudScore",
        "source": "E11",
        "sourceHandle": "TransactionQueue",
        "target": "E21",
        "targetHandle": "FraudScore",
        "animated": true,
        "style": {
          "stroke": "#007bff",
          "strokeWidth": 2
      ...
      {
        "id": "FraudScore-TxnEntry",
        "source": "E21",
        "sourceHandle": "FraudScore",
        "target": "E31",
        "targetHandle": "TxnEntry",
        "animated": true,
        "style": {
